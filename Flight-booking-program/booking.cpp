...
int menu_choice ;
do{
cout << "\n\n\n____________[ Welecom to Bengaluru Airport]______________\n"
     << "                       MAIN MENU                      \n"
     << "                    ENTER YOUR CHOICE                   \n"
...
obj.setAge(age);
   ...
   cout << "\n\n   __________________________________[Bengaluru Airport ]________________________________________\n\n"
  ...
  cout << "Do you want book another fligt \n"
      ...
      if (x == 1){
		...
		system("cls");
		cout << " \n\n\n\n\n   __________ Thank you to use Bengaluru Airport _________ \n Programe will exit now ";
		Sleep(1500);
		exit(0);
		}
		else {
